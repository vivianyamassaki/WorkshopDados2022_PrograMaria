"""
Esse é um script simples que foi criado antes para fazermos o treinamento do modelo utilizando o conjunto de dados do Titanic
e o pipeline da Feature Engineering que mostramos no Workshop. Para executá-lo, você deve estar na raiz do modelo e digitar
